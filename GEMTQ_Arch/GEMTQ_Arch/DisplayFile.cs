...
namespace GEMTQ_Arch
{
    public partial class DisplayFile : Form
    {
        ...
        private void DisplayFile_Load(object sender, EventArgs e)
        {
            ...
            das.GET_data(Convert.ToInt32(FileDetails.getMainForm.dataGridView1.Rows[0].Cells[0].Value));
            string s = "select *from DataTableTempSecondary where DocID='" + Convert.ToInt32(FileDetails.getMainForm.dataGridView1.Rows[0].Cells[0].Value)+"'";
        ...
        {
            string s = "delete from DataTableTempSecondary where DocID='" + Convert.ToInt32(FileDetails.getMainForm.dataGridView1.Rows[0].Cells[0].Value) + "'";
            SqlCommand cmd = new SqlCommand(s, con);
            try
            {
                con.Open();

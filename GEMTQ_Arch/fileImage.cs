...
namespace GEMTQ_Arch
{
    public partial class fileImage : Form
    {
        ...
        {
            this.Close();
            string s = "delete from GetDATA where DocID='" + Convert.ToInt32(fileslist.getMainForm.dataGridView1.Rows[0].Cells[0].Value) + "'";
        ...
        private void fileImage_Load(object sender, EventArgs e)
        {
            ...
            id = Convert.ToInt32(fileslist.getMainForm.dataGridView1.CurrentRow.Cells[0].Value);
            num = Convert.ToInt32(fileslist.getMainForm.dataGridView1.CurrentRow.Cells[12].Value);
            sa.GET_data(id, num);
        ...
        {
            string s = "select *from GetDATA where DocID='" + Convert.ToInt32(fileslist.getMainForm.dataGridView1.CurrentRow.Cells[0].Value) + "'";
            SqlCommand cmd = new SqlCommand(s, con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
                da.Fill(dt);

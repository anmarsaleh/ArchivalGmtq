...
namespace GEMTQ_Arch
{
    public partial class userslist : Form
    {
        ...
        {
            string s = "select UserID as 'رقم المستخدم',UserName as 'اسم المستخدم', ActiveUser as 'الحساب مفعل',IsAdmin as 'مدير أو موظف' from Users where  UserID or UserName or ActiveUser or IsAdmin like '%" + textBox1.Text + "%'";
            SqlCommand cmd = new SqlCommand(s, con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
                da.Fill(dt);
